...
import { useGetAllIncomeQuery } from "../../../redux/features/income_expense/income/incomeApi";
...
import IncomeReportsPdf from "./IncomeReportsPdf";
import IncomeReportsTableUI from "./IncomeReportsTableUI";

const IncomeReports = () => {
  document.title = "Income Reports";
  ...
  const {
    ...
    isError,
    isFetching,
  } = useGetAllIncomeQuery(`${newFilterQuery}&filter_report=Report`);
  ...
  const handleTablePdfDownload = () => {
    ...
    addCenteredText(`Income Reports`, 10, 14, 12);
    addCenteredText(`Data: ${getCurrentDateWithLastYear()}`, 7, 19, 9);

    autoTable(pdf, {
      html: "#income-report-table",
      headStyles: {
        fillColor: "#dedede",
        textColor: "#2e2e3e",
        lineColor: "#dedede",
      ...
      didParseCell: function (data) {
        ...
        data.cell.styles.halign = [5, 6].includes(data.column.index)
          ? "center"
          : "left";
      },
