...
import SalesReportsPdf from "./SalesReportsPdf";
import SalesReportsTableUI from "./SalesReportsTableUI";

const SalesReports = () => {
  document.title = "Sales Reports";
  ...
  const {
    ...
    isError,
    isFetching,
  } = useGetSalesQuery(`${newFilterQuery}&filter_report=Report`);
  ...
  const handleTablePdfDownload = () => {
    ...
    addCenteredText(`Sales Reports`, 11, 14, 12);
              ...
              <div className="total-count-area mt-2">
                <div className="count-item light-blue">
                  <h5>
                    $
                    {getNumberWithCommas(
                      twoDigitFixed(sale_filter?.sale_total || 0)
                    )}
                  </h5>
                  <p>Total Sale</p>
                </div>
                <div className="count-item light-green">
                  <h5>
                    $
                    {getNumberWithCommas(
                      twoDigitFixed(sale_filter?.sale_paid || 0)
                    )}
                  </h5>
                  <p>Total Paid</p>
                </div>
                <div className="count-item light-orange">
                  <h5>
                    $
                    {getNumberWithCommas(
                      twoDigitFixed(sale_filter?.sale_due || 0)
                    )}
                  </h5>
                  <p>Total Unpaid</p>
                </div>
