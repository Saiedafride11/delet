...
import { useGetAllExpenseQuery } from "../../../redux/features/income_expense/expense/expenseApi";
...
import ExpenseReportsPdf from "./ExpenseReportsPdf";
...
const ExpenseReports = () => {
  ...
  const {
    ...
    isError,
    isFetching,
  } = useGetAllExpenseQuery(`${newFilterQuery}&filter_report=Report`);
  ...
  const handleTablePdfDownload = () => {
    ...
    addCenteredText(`Expense Reports`, 10, 14, 12);
    addCenteredText(`Data: ${getCurrentDateWithLastYear()}`, 7, 19, 9);

    autoTable(pdf, {
      html: "#expense-report-table",
      headStyles: {
        fillColor: "#dedede",
        textColor: "#2e2e3e",
        lineColor: "#dedede",
