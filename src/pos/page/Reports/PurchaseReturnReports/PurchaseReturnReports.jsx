...
import { useGetPurchasesReturnQuery } from "../../../redux/features/purchase/return/purchaseReturnApi";
...
import PurchaseReturnReportsPdf from "./PurchaseReturnReportsPdf";
import PurchaseReturnReportsTableUI from "./PurchaseReturnReportsTableUI";

const PurchaseReturnReports = () => {
  document.title = "Purchase Return Reports";
  ...
  const {
    ...
    isError,
    isFetching,
  } = useGetPurchasesReturnQuery(`${newFilterQuery}&filter_report=Report`);
  ...
  const handleTablePdfDownload = () => {
    ...
    addCenteredText(`Purchase Return Reports`, 11, 14, 12);
    addCenteredText(`Data: ${getCurrentDateWithLastYear()}`, 7, 19, 9);

    autoTable(pdf, {
      html: "#purchase-return-report-table",
      headStyles: {
        fillColor: "#dedede",
        textColor: "#2e2e3e",
        lineColor: "#dedede",
              ...
              <div className="total-count-area mt-2">
                <div className="count-item light-blue">
                  <h5>
                    ...
                    {getNumberWithCommas(
                      twoDigitFixed(
                        purchaseReturnData?.data?.total_grand_total || 0
                      )
                    )}
                  </h5>
