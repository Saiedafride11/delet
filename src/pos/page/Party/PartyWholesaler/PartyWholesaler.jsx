...
const PartyWholesaler = () => {
  document.title = "Party Wholesaler";
  ...
  const addFilterQuery =
    filterQuery === "" ? "?filter=4" : filterQuery + "&filter=4";
  const {
    data: partyData,
    isLoading,
    isError,
          ...
          <div className="dashboard-details-table-wrapper">
            <div className="table-top-form daily-transaction-between-wrapper pt-0">
              ...
              <div className="table-top-btn-group">
                <TableTopButtons arrayData={tableData} title="Wholesaler" />
              </div>
            </div>
...
export default PartyWholesaler;
