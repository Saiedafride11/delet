...
const SalesInvoice = () => {
  ...
  const { data: saleData, isLoading: saleIsLoading } =
    useGetSaleQuery(invoiceId);
  const initialData = saleData?.data?.sale;
      ...
      {saleIsLoading ? (
        ...
        <div className="container print-max-w">
          ...
          <div className="invoice-content print-p-15">
            <div>
              <StoreInfo />
              <InvoiceTitle initialData={initialData} title="Invoice/Bill" />
