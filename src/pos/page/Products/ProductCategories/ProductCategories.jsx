...
} from "../../../redux/features/products/categories/productCategoriesApi";
...
const ProductCategories = () => {
  ...
  const {
    ...
    handleSearchChange,
    dataFrom,
  } = useFilterSearchQueryLocal(productCategories?.data?.product_categories);
  ...
  // console.log("object", productCategories?.data?.product_categories);
  return (
          ...
          <div className="details-header print-d-none">
            <div className="title">
              ...
              <Link
                ...
                data-bs-target="#product-category-modal"
          ...
          <div className="dashboard-details-table-wrapper">
            <div className="table-top-form daily-transaction-between-wrapper pt-0">
              ...
              <div className="table-top-btn-group">
                <TableTopButtons arrayData={tableData} title="Categories" />
              </div>
            </div>
