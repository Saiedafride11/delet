...
const ProductWarranty = () => {
  ...
  const {
    ...
    handleSearchChange,
    dataFrom,
  } = useFilterSearchQueryLocal(productWarranty?.data?.warranty);
  ...
  // console.log("productWarranty", productWarranty?.data?.warranty);
          ...
          <div className="details-header print-d-none">
            <div className="title">
              ...
              <Link
                ...
                data-bs-target="#product-warranty-modal"
                className="btn custom-btn"
              >
                <span>+</span> Add Warranty
              </Link>
            </div>
          </div>
          {/* Filter Tab start */}
          ...
          <div className="dashboard-details-table-wrapper">
            <div className="table-top-form daily-transaction-between-wrapper pt-0">
              ...
              <div className="table-top-btn-group">
                <TableTopButtons arrayData={tableData} title="Warranty" />
              </div>
            </div>
