...
const ProductWeightModal = ({ updateData, setUpdateData = () => {} }) => {
  const [
    addProductWeight,
    {
        ...
        <div className="modal-content">
          <div className="modal-header">
            <h1 className="modal-title fs-5 fw-bold" id="exampleModalLabel">
              {updateData?.name ? "Update Weight" : "Add New Weight"}
            </h1>
            <button
              type="button"
              className="btn-close"
...
export default React.memo(ProductWeightModal);
