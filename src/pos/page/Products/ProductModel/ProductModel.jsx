...
const ProductModel = () => {
  ...
  const { data: productModel, isLoading, isError } = useGetProductModelQuery();
  ...
  const {
    ...
    handleSearchChange,
    dataFrom,
  } = useFilterSearchQueryLocal(productModel?.data?.model);
          ...
          <div className="details-header print-d-none">
            <div className="title">
              ...
              <Link
                ...
                data-bs-target="#product-model-modal"
          ...
          <div className="dashboard-details-table-wrapper">
            <div className="table-top-form daily-transaction-between-wrapper pt-0">
              ...
              <div className="table-top-btn-group">
                <TableTopButtons arrayData={tableData} title="Model" />
              </div>
            </div>
