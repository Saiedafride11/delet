...
const ProductCapacity = () => {
  ...
  const {
    ...
    handleSearchChange,
    dataFrom,
  } = useFilterSearchQueryLocal(productCapacity?.data?.capacity);
  ...
  // console.log("productCapacity", productCapacity?.data?.capacity);
          ...
          <div className="dashboard-details-table-wrapper">
            <div className="table-top-form daily-transaction-between-wrapper pt-0">
              ...
              <div className="table-top-btn-group">
                <TableTopButtons arrayData={tableData} title="Capacity" />
              </div>
            </div>
