...
const ProductType = () => {
  ...
  const { data: productType, isLoading, isError } = useGetProductTypeQuery();
  ...
  const {
    ...
    handleSearchChange,
    dataFrom,
  } = useFilterSearchQueryLocal(productType?.data?.type);
  ...
  return (
    <div className="acnoo-dashboard-main-section">
          ...
          <div className="dashboard-details-table-wrapper">
            <div className="table-top-form daily-transaction-between-wrapper pt-0">
              ...
              <div className="table-top-btn-group">
                <TableTopButtons arrayData={tableData} title="Type" />
              </div>
            </div>
      ...
      <ProductTypeModal updateData={updateData} setUpdateData={setUpdateData} />
      <DeleteModal
        handleDelete={
