            ...
            {formValue?.items?.length === 0 ? (
              ...
              formValue?.items?.map((data, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <div className="qty-sold">{data?.purchased_quantity}</div>
                  </td>
                        ...
                        <td>
                          <div className="w-40 mx-auto d-flex align-items-center justify-content-between">
                            ...
                            <button
                              ...
                              disabled={data?.purchased_quantity <= 0}
                              className={`border-0 bg-transparent p-0 ${
                                data?.purchased_quantity <= 0 && "opacity-50"
                              }`}
                  ...
                  <td>
                    ${getNumberWithCommas(twoDigitFixed(data?.purchase_price))}
                  </td>
