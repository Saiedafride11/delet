...
const ExpenseListViewModal = ({ updateData, setUpdateData }) => {
  return (
    <div
            ...
            <div className="view-description">
              <ul>
                <li>
                  ...
                  <strong>
                    {updateData?.expense_date !== null
                      ? getMonthDayYearFormat(updateData?.expense_date)
                      : "----"}
                  </strong>
                </li>
                <li>
                  <span>Expense for</span> <span>:</span>
...
export default React.memo(ExpenseListViewModal);
